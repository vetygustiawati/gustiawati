...
<html lang="en">
   <head>
      ...
      <!--animate css-->
      <link rel="stylesheet" href="{{url('public')}}/css/animate-wow.css">
      <!--main css-->
      <link rel="stylesheet" href="{{url('public')}}/css/style.css">
      <link rel="stylesheet" href="{{url('public')}}/css/bootstrap-select.min.css">
      <link rel="stylesheet" href="{{url('public')}}/css/slick.min.css">
      <!--responsive css-->
   ...
   <body>
                        ...
                        <div class="nav-b hidden-xs">
                           <div class="nav-box">
                              <ul>
                                 ...
                                 <li><a href="{{ url ("/profil2")}}">Profil</a></li>
                                 <li><a href="{{ url ("/produk2")}}">Product</a></li>
                                 <li><a href="{{ url ("/kategori2")}}">Kategori</a></li>
      ...
      <!--main js--> 
      <script src="{{url('public')}}/js/jquery-1.12.4.min.js"></script> 
      <!--bootstrap js--> 
