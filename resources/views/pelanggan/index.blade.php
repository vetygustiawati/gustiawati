		...
		<div class="col-md-12 mt-5">
			<div class="card">
				<div class="card-header">
					Data Pelanggan
					<a href="{{url('pelanggan/create')}}" class="btn btn-dark float-right"><i class="fa fa-plus"></i>Tambah Data</a>
				</div>
				<div class="card-body">
					<table class="table">
							<thead>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											@include('admin.utils.delete', ['url' => url('pelanggan', $pelanggan->id)])
											</div>
										</td>
