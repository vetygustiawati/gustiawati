                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a href="{{url('about')}}" class="nav-link"><span class="fa-home fa"></span> About</a>
                                
                            </li>
                            <li class="nav-item ">
                                <a href="{{url('profil')}}" class="nav-link"><span class="fa-home fa"></span> Profil</a>
                                
                            </li>
                            <li class="nav-item ">
                                <a href="{{url('admin/produk')}}" class="nav-link"><span class="fa-home fa"></span> Produk</a>
                                
                            </li>
                            <li class="nav-item ">
                                <a href="{{url('admin/kategori')}}" class="nav-link"><span class="fa-home fa"></span> Kategori</a>
